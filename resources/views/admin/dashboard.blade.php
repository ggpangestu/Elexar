...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
  <div class="bg-white shadow-md rounded-lg p-6">
    <h2 class="text-lg font-semibold text-gray-700 mb-2">Jumlah User</h2>
    <p class="text-3xl font-bold text-blue-500">120</p>
  </div>

  <div class="bg-white shadow-md rounded-lg p-6">
    <h2 class="text-lg font-semibold text-gray-700 mb-2">Jumlah Admin</h2>
    <p class="text-3xl font-bold text-green-500">5</p>
  </div>

  <div class="bg-white shadow-md rounded-lg p-6">
    <h2 class="text-lg font-semibold text-gray-700 mb-2">Permintaan Meeting</h2>
...
<div class="bg-white shadow-md rounded-lg p-6">
  <div class="flex flex-col sm:flex-row justify-between mb-4 gap-4">
    <!-- Jenis Data -->
    <div>
      <label for="dataType" class="block font-semibold text-gray-700 mb-1">Jenis Data</label>
      <select id="dataType" class="p-2 rounded border">
    ...
    <!-- Rentang Waktu -->
    <div>
      <label for="timeRange" class="block font-semibold text-gray-700 mb-1">Rentang Waktu</label>
      <select id="timeRange" class="p-2 rounded border">
